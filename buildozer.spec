...
requirements = python3,hostpython3,kivy==2.3.0,pyjnius==1.4.2,kivymd==1.2.0,aiohttp,requests,cython,certifi,openssl,urllib3,idna,charset-normalizer,multidict,yarl,six,filetype
