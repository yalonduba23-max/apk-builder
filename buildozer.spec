...
requirements = python3==3.11.0,hostpython3==3.11.0,kivy==2.3.0,pyjnius,kivymd==0.104.2,aiohttp,requests,cython,certifi,openssl,urllib3,idna,charset-normalizer,multidict,async_timeout,attrs,yarl,six,filetype
