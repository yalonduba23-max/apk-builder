...
requirements = python3==3.10.8,kivy==2.2.1,kivymd==1.1.1,cython,requests,certifi,openssl,urllib3,idna,charset-normalizer,multidict,async_timeout,attrs,yarl,six,filetype
