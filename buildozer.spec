...
requirements = python3==3.11,hostpython3==3.11,kivy==2.3.0,pyjnius==1.4.2,kivymd==1.2.0,aiohttp,requests,cython,certifi,openssl,urllib3,idna,charset-normalizer,multidict,yarl,six
